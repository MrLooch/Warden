(function () {
    ...
    DashboardController.$inject = ['$location', 'uiGmapGoogleMapApi'];

    function DashboardController($location,GoogleMapApi) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'Dashboard';
        // Google API key is 
        vm.googleMapsUrl = "https://maps.googleapis.com/maps/api/js?key=AIzaSyD5WDI_JPLzXkpC74dKveD6Y-luoljtDxc";
